...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[specifiedSubstance.JSON]) with (
        ...
        [specifiedSubstance.group.id]  NVARCHAR(4000)      '$.group.id',
        ...
        [specifiedSubstance.confidentiality.id] NVARCHAR(4000)      '$.confidentiality.id',
