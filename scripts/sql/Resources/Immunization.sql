CREATE EXTERNAL TABLE [fhir].[Immunization] (
    ...
    [fundingSource.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[subpotentReason.JSON]) with (
        [subpotentReason.id]           NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[programEligibility.JSON]) with (
        [programEligibility.id]        NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[protocolApplied.JSON]) with (
        [protocolApplied.id]           NVARCHAR(4000)      '$.id',
        ...
        [protocolApplied.authority.id] NVARCHAR(4000)      '$.authority.id',
