...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[gene.JSON]) with (
        ...
        [gene.gene.id]                 NVARCHAR(4000)      '$.gene.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[geneElement.JSON]) with (
        ...
        [geneElement.element.id]       NVARCHAR(4000)      '$.element.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[classification.JSON]) with (
        ...
        [classification.classification.id] NVARCHAR(4000)      '$.classification.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[target.JSON]) with (
        ...
        [target.target.id]             NVARCHAR(4000)      '$.target.id',
        ...
        [target.type.id]               NVARCHAR(4000)      '$.type.id',
        ...
        [target.interaction.id]        NVARCHAR(4000)      '$.interaction.id',
        ...
        [target.organism.id]           NVARCHAR(4000)      '$.organism.id',
        ...
        [target.organismType.id]       NVARCHAR(4000)      '$.organismType.id',
        ...
        [target.amountType.id]         NVARCHAR(4000)      '$.amountType.id',
        ...
        [target.amount.Quantity.id]    NVARCHAR(4000)      '$.amount.Quantity.id',
        ...
        [target.amount.Quantity.unit]  NVARCHAR(4000)      '$.amount.Quantity.unit',
        ...
        [target.amount.Range.id]       NVARCHAR(4000)      '$.amount.Range.id',
