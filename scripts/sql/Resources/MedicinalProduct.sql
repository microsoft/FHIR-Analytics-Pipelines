CREATE EXTERNAL TABLE [fhir].[MedicinalProduct] (
    ...
    [paediatricUseIndicator.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[productClassification.JSON]) with (
        [productClassification.id]     NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[marketingStatus.JSON]) with (
        ...
        [marketingStatus.jurisdiction.id] NVARCHAR(4000)      '$.jurisdiction.id',
        ...
        [marketingStatus.status.id]    NVARCHAR(4000)      '$.status.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[pharmaceuticalProduct.JSON]) with (
        [pharmaceuticalProduct.id]     NVARCHAR(4000)      '$.id',
        ...
        [pharmaceuticalProduct.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[packagedMedicinalProduct.JSON]) with (
        [packagedMedicinalProduct.id]  NVARCHAR(4000)      '$.id',
        ...
        [packagedMedicinalProduct.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[attachedDocument.JSON]) with (
        [attachedDocument.id]          NVARCHAR(4000)      '$.id',
        ...
        [attachedDocument.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[contact.JSON]) with (
        ...
        [contact.identifier.id]        NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[clinicalTrial.JSON]) with (
        [clinicalTrial.id]             NVARCHAR(4000)      '$.id',
        ...
        [clinicalTrial.identifier.id]  NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[name.JSON]) with (
        ...
        [name.productName]             NVARCHAR(4000)      '$.productName',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[crossReference.JSON]) with (
        ...
        [crossReference.period.id]     NVARCHAR(4000)      '$.period.id',
        [crossReference.period.extension] NVARCHAR(MAX)       '$.period.extension',
        [crossReference.period.start]  VARCHAR(30)         '$.period.start',
        [crossReference.period.end]    VARCHAR(30)         '$.period.end',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[manufacturingBusinessOperation.JSON]) with (
        [manufacturingBusinessOperation.id] NVARCHAR(4000)      '$.id',
        ...
        [manufacturingBusinessOperation.operationType.id] NVARCHAR(4000)      '$.operationType.id',
        ...
        [manufacturingBusinessOperation.authorisationReferenceNumber.id] NVARCHAR(4000)      '$.authorisationReferenceNumber.id',
        ...
        [manufacturingBusinessOperation.effectiveDate] VARCHAR(30)         '$.effectiveDate',
        ...
        [manufacturingBusinessOperation.regulator.id] NVARCHAR(4000)      '$.regulator.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[specialDesignation.JSON]) with (
        [specialDesignation.id]        NVARCHAR(4000)      '$.id',
        ...
        [specialDesignation.type.id]   NVARCHAR(4000)      '$.type.id',
        ...
        [specialDesignation.intendedUse.id] NVARCHAR(4000)      '$.intendedUse.id',
        ...
        [specialDesignation.status.id] NVARCHAR(4000)      '$.status.id',
        ...
        [specialDesignation.date]      VARCHAR(30)         '$.date',
        ...
        [specialDesignation.indication.CodeableConcept.id] NVARCHAR(4000)      '$.indication.CodeableConcept.id',
        ...
        [specialDesignation.indication.Reference.id] NVARCHAR(4000)      '$.indication.Reference.id',
