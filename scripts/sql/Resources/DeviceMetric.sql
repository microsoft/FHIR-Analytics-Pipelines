CREATE EXTERNAL TABLE [fhir].[DeviceMetric] (
    ...
    [measurementPeriod.id] NVARCHAR(4000),
    ...
    [measurementPeriod.repeat.id] NVARCHAR(4000),
    ...
    [measurementPeriod.code.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[calibration.JSON]) with (
        [calibration.id]               NVARCHAR(4000)      '$.id',
        ...
        [calibration.time]             VARCHAR(30)         '$.time'
    ) j
