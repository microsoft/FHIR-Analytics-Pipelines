CREATE EXTERNAL TABLE [fhir].[Account] (
    ...
    [name] NVARCHAR(4000),
    [subject] VARCHAR(MAX),
    [servicePeriod.id] NVARCHAR(4000),
    [servicePeriod.extension] NVARCHAR(MAX),
    [servicePeriod.start] VARCHAR(30),
    [servicePeriod.end] VARCHAR(30),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[coverage.JSON]) with (
        ...
        [coverage.coverage.id]         NVARCHAR(4000)      '$.coverage.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[guarantor.JSON]) with (
        ...
        [guarantor.period.id]          NVARCHAR(4000)      '$.period.id',
        [guarantor.period.extension]   NVARCHAR(MAX)       '$.period.extension',
        [guarantor.period.start]       VARCHAR(30)         '$.period.start',
        [guarantor.period.end]         VARCHAR(30)         '$.period.end'
    ) j
