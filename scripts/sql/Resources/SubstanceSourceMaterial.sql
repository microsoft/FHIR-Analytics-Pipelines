CREATE EXTERNAL TABLE [fhir].[SubstanceSourceMaterial] (
    ...
    [organismId.period.id] NVARCHAR(4000),
    [organismId.period.extension] NVARCHAR(MAX),
    [organismId.period.start] VARCHAR(30),
    [organismId.period.end] VARCHAR(30),
    ...
    [organism.hybrid.id] NVARCHAR(4000),
    [organism.hybrid.extension] NVARCHAR(MAX),
    [organism.hybrid.modifierExtension] NVARCHAR(MAX),
    [organism.hybrid.maternalOrganismId] NVARCHAR(4000),
    [organism.hybrid.maternalOrganismName] NVARCHAR(4000),
    [organism.hybrid.paternalOrganismId] NVARCHAR(4000),
    [organism.hybrid.paternalOrganismName] NVARCHAR(4000),
    [organism.hybrid.hybridType] NVARCHAR(MAX),
    [organism.organismGeneral.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[parentSubstanceId.JSON]) with (
        ...
        [parentSubstanceId.period.id]  NVARCHAR(4000)      '$.period.id',
        [parentSubstanceId.period.extension] NVARCHAR(MAX)       '$.period.extension',
        [parentSubstanceId.period.start] VARCHAR(30)         '$.period.start',
        [parentSubstanceId.period.end] VARCHAR(30)         '$.period.end',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[countryOfOrigin.JSON]) with (
        [countryOfOrigin.id]           NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[fractionDescription.JSON]) with (
        [fractionDescription.id]       NVARCHAR(4000)      '$.id',
        [fractionDescription.extension] NVARCHAR(MAX)       '$.extension',
        [fractionDescription.modifierExtension] NVARCHAR(MAX)       '$.modifierExtension',
        [fractionDescription.fraction] NVARCHAR(4000)      '$.fraction',
        [fractionDescription.materialType.id] NVARCHAR(4000)      '$.materialType.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[partDescription.JSON]) with (
        ...
        [partDescription.partLocation.id] NVARCHAR(4000)      '$.partLocation.id',
