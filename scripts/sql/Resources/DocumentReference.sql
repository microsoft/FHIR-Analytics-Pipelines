CREATE EXTERNAL TABLE [fhir].[DocumentReference] (
    ...
    [masterIdentifier.id] NVARCHAR(4000),
    [masterIdentifier.extension] NVARCHAR(MAX),
    [masterIdentifier.use] NVARCHAR(64),
    [masterIdentifier.type.id] NVARCHAR(4000),
    ...
    [masterIdentifier.period.id] NVARCHAR(4000),
    [masterIdentifier.period.extension] NVARCHAR(MAX),
    [masterIdentifier.period.start] VARCHAR(30),
    [masterIdentifier.period.end] VARCHAR(30),
    ...
    [context.period.id] NVARCHAR(4000),
    [context.period.extension] NVARCHAR(MAX),
    [context.period.start] VARCHAR(30),
    [context.period.end] VARCHAR(30),
    ...
    [context.practiceSetting.id] NVARCHAR(4000),
    ...
    [context.sourcePatientInfo.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[author.JSON]) with (
        ...
        [author.identifier.id]         NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[relatesTo.JSON]) with (
        ...
        [relatesTo.target.id]          NVARCHAR(4000)      '$.target.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[securityLabel.JSON]) with (
        [securityLabel.id]             NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[content.JSON]) with (
        ...
        [content.attachment.id]        NVARCHAR(4000)      '$.attachment.id',
        [content.attachment.extension] NVARCHAR(MAX)       '$.attachment.extension',
        [content.attachment.contentType] NVARCHAR(4000)      '$.attachment.contentType',
        [content.attachment.language]  NVARCHAR(4000)      '$.attachment.language',
        ...
        [content.attachment.creation]  VARCHAR(30)         '$.attachment.creation',
        ...
        [content.format.version]       NVARCHAR(4000)      '$.format.version',
