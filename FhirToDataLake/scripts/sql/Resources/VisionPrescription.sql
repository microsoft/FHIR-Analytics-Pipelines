CREATE EXTERNAL TABLE [fhir].[VisionPrescription] (
    ...
    [prescriber.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[lensSpecification.JSON]) with (
        ...
        [lensSpecification.duration.id] NVARCHAR(4000)      '$.duration.id',
        ...
        [lensSpecification.duration.unit] NVARCHAR(4000)      '$.duration.unit',
        [lensSpecification.duration.system] VARCHAR(256)        '$.duration.system',
        [lensSpecification.duration.code] NVARCHAR(4000)      '$.duration.code',
        [lensSpecification.color]      NVARCHAR(4000)      '$.color',
        [lensSpecification.brand]      NVARCHAR(4000)      '$.brand',
