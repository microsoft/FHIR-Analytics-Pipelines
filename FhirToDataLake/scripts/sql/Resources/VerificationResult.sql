CREATE EXTERNAL TABLE [fhir].[VerificationResult] (
    ...
    [attestation.onBehalfOf.id] NVARCHAR(4000),
    ...
    [attestation.communicationMethod.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[target.JSON]) with (
        ...
        [target.identifier.id]         NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[validationProcess.JSON]) with (
        [validationProcess.id]         NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[primarySource.JSON]) with (
        ...
        [primarySource.validationStatus.id] NVARCHAR(4000)      '$.validationStatus.id',
        ...
        [primarySource.validationDate] VARCHAR(30)         '$.validationDate',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[validator.JSON]) with (
        ...
        [validator.attestationSignature.id] NVARCHAR(4000)      '$.attestationSignature.id',
        ...
        [validator.attestationSignature.when] VARCHAR(30)         '$.attestationSignature.when',
        ...
        [validator.attestationSignature.targetFormat] NVARCHAR(4000)      '$.attestationSignature.targetFormat',
        [validator.attestationSignature.sigFormat] NVARCHAR(4000)      '$.attestationSignature.sigFormat',
