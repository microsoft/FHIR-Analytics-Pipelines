CREATE EXTERNAL TABLE [fhir].[VerificationResult] (
    ...
    [attestation.proxySignature.targetFormat] NVARCHAR(500),
    [attestation.proxySignature.sigFormat] NVARCHAR(500),
    ...
    [attestation.sourceSignature.targetFormat] NVARCHAR(500),
    [attestation.sourceSignature.sigFormat] NVARCHAR(500),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[validator.JSON]) with (
        ...
        [validator.attestationSignature.targetFormat] NVARCHAR(500)       '$.attestationSignature.targetFormat',
        [validator.attestationSignature.sigFormat] NVARCHAR(500)       '$.attestationSignature.sigFormat',
