CREATE EXTERNAL TABLE [fhir].[ResearchStudy] (
    ...
    [sponsor.identifier.id] NVARCHAR(4000),
    ...
    [principalInvestigator.id] NVARCHAR(4000),
    ...
    [principalInvestigator.identifier.id] NVARCHAR(4000),
    ...
    [site] VARCHAR(MAX),
    [reasonStopped.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[objective.JSON]) with (
        [objective.id]                 NVARCHAR(4000)      '$.id',
        [objective.extension]          NVARCHAR(MAX)       '$.extension',
        [objective.modifierExtension]  NVARCHAR(MAX)       '$.modifierExtension',
        [objective.name]               NVARCHAR(4000)      '$.name',
        [objective.type.id]            NVARCHAR(4000)      '$.type.id',
