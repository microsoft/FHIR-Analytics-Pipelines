CREATE EXTERNAL TABLE [fhir].[SpecimenDefinition] (
    ...
    [typeCollected.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[patientPreparation.JSON]) with (
        [patientPreparation.id]        NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[collection.JSON]) with (
        [collection.id]                NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[typeTested.JSON]) with (
        [typeTested.id]                NVARCHAR(4000)      '$.id',
        ...
        [typeTested.type.id]           NVARCHAR(4000)      '$.type.id',
        ...
        [typeTested.container.id]      NVARCHAR(4000)      '$.container.id',
        ...
        [typeTested.requirement]       NVARCHAR(4000)      '$.requirement',
        [typeTested.retentionTime.id]  NVARCHAR(4000)      '$.retentionTime.id',
        ...
        [typeTested.retentionTime.unit] NVARCHAR(4000)      '$.retentionTime.unit',
