CREATE EXTERNAL TABLE [fhir].[MolecularSequence] (
    ...
    [referenceSeq.referenceSeqId.id] NVARCHAR(4000),
    ...
    [referenceSeq.referenceSeqPointer.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[variant.JSON]) with (
        ...
        [variant.variantPointer.id]    NVARCHAR(4000)      '$.variantPointer.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[quality.JSON]) with (
        ...
        [quality.standardSequence.id]  NVARCHAR(4000)      '$.standardSequence.id',
        ...
        [quality.score.id]             NVARCHAR(4000)      '$.score.id',
        ...
        [quality.roc.id]               NVARCHAR(4000)      '$.roc.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[repository.JSON]) with (
        [repository.id]                NVARCHAR(4000)      '$.id',
        ...
        [repository.name]              NVARCHAR(4000)      '$.name',
        [repository.datasetId]         NVARCHAR(4000)      '$.datasetId',
        [repository.variantsetId]      NVARCHAR(4000)      '$.variantsetId',
        [repository.readsetId]         NVARCHAR(4000)      '$.readsetId'
    ) j
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[structureVariant.JSON]) with (
        ...
        [structureVariant.outer.id]    NVARCHAR(4000)      '$.outer.id',
        ...
        [structureVariant.inner.id]    NVARCHAR(4000)      '$.inner.id',
