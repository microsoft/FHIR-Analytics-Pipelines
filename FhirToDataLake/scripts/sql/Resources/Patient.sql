CREATE EXTERNAL TABLE [fhir].[Patient] (
    ...
    [managingOrganization.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[contact.JSON]) with (
        ...
        [contact.organization.id]      NVARCHAR(4000)      '$.organization.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[communication.JSON]) with (
        ...
        [communication.language.id]    NVARCHAR(4000)      '$.language.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[generalPractitioner.JSON]) with (
        [generalPractitioner.id]       NVARCHAR(4000)      '$.id',
        ...
        [generalPractitioner.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[link.JSON]) with (
        ...
        [link.other.id]                NVARCHAR(4000)      '$.other.id',
