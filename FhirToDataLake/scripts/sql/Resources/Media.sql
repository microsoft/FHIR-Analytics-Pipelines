CREATE EXTERNAL TABLE [fhir].[Media] (
    ...
    [operator.identifier.id] NVARCHAR(4000),
    ...
    [frames] bigint,
    [duration] float,
    [content.id] NVARCHAR(4000),
    [content.extension] NVARCHAR(MAX),
    [content.contentType] NVARCHAR(4000),
    [content.language] NVARCHAR(4000),
    [content.data] NVARCHAR(MAX),
    [content.url] VARCHAR(256),
    [content.size] bigint,
    [content.hash] NVARCHAR(MAX),
    [content.title] NVARCHAR(4000),
    [content.creation] VARCHAR(30),
    [note] VARCHAR(MAX),
    [created.dateTime] VARCHAR(30),
    [created.Period.id] NVARCHAR(4000),
    [created.Period.extension] NVARCHAR(MAX),
    [created.Period.start] VARCHAR(30),
    [created.Period.end] VARCHAR(30),
) WITH (
    LOCATION='/Media/**',
