CREATE EXTERNAL TABLE [fhir].[MedicinalProductPharmaceutical] (
    ...
    [administrableDoseForm.id] NVARCHAR(4000),
    ...
    [unitOfPresentation.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[ingredient.JSON]) with (
        ...
        [ingredient.identifier.id]     NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[characteristics.JSON]) with (
        ...
        [characteristics.status.id]    NVARCHAR(4000)      '$.status.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[routeOfAdministration.JSON]) with (
        [routeOfAdministration.id]     NVARCHAR(4000)      '$.id',
        ...
        [routeOfAdministration.code.id] NVARCHAR(4000)      '$.code.id',
        ...
        [routeOfAdministration.firstDose.id] NVARCHAR(4000)      '$.firstDose.id',
        ...
        [routeOfAdministration.firstDose.unit] NVARCHAR(4000)      '$.firstDose.unit',
        ...
        [routeOfAdministration.maxSingleDose.id] NVARCHAR(4000)      '$.maxSingleDose.id',
        ...
        [routeOfAdministration.maxSingleDose.unit] NVARCHAR(4000)      '$.maxSingleDose.unit',
        ...
        [routeOfAdministration.maxDosePerDay.id] NVARCHAR(4000)      '$.maxDosePerDay.id',
        ...
        [routeOfAdministration.maxDosePerDay.unit] NVARCHAR(4000)      '$.maxDosePerDay.unit',
        ...
        [routeOfAdministration.maxDosePerTreatmentPeriod.id] NVARCHAR(4000)      '$.maxDosePerTreatmentPeriod.id',
        ...
        [routeOfAdministration.maxTreatmentPeriod.id] NVARCHAR(4000)      '$.maxTreatmentPeriod.id',
        ...
        [routeOfAdministration.maxTreatmentPeriod.unit] NVARCHAR(4000)      '$.maxTreatmentPeriod.unit',
