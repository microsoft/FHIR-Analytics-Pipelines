CREATE EXTERNAL TABLE [fhir].[ChargeItem] (
    ...
    [performingOrganization.id] NVARCHAR(4000),
    ...
    [performingOrganization.identifier.id] NVARCHAR(4000),
    ...
    [requestingOrganization.id] NVARCHAR(4000),
    ...
    [requestingOrganization.identifier.id] NVARCHAR(4000),
    ...
    [priceOverride.id] NVARCHAR(4000),
    [priceOverride.extension] NVARCHAR(MAX),
    [priceOverride.value] float,
    [priceOverride.currency] NVARCHAR(4000),
