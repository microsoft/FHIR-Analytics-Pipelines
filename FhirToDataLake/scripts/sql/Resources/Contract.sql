CREATE EXTERNAL TABLE [fhir].[Contract] (
    ...
    [contentDefinition.publicationStatus] NVARCHAR(64),
    ...
    [legallyBinding.attachment.contentType] NVARCHAR(64),
    [legallyBinding.attachment.language] NVARCHAR(12),
    ...
    [legallyBinding.attachment.title] NVARCHAR(500),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[friendly.JSON]) with (
        ...
        [friendly.content.attachment.contentType] NVARCHAR(64)        '$.content.attachment.contentType',
        [friendly.content.attachment.language] NVARCHAR(12)        '$.content.attachment.language',
        ...
        [friendly.content.attachment.title] NVARCHAR(500)       '$.content.attachment.title',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[legal.JSON]) with (
        ...
        [legal.content.attachment.contentType] NVARCHAR(64)        '$.content.attachment.contentType',
        [legal.content.attachment.language] NVARCHAR(12)        '$.content.attachment.language',
        ...
        [legal.content.attachment.title] NVARCHAR(500)       '$.content.attachment.title',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[rule.JSON]) with (
        ...
        [rule.content.attachment.contentType] NVARCHAR(64)        '$.content.attachment.contentType',
        [rule.content.attachment.language] NVARCHAR(12)        '$.content.attachment.language',
        ...
        [rule.content.attachment.title] NVARCHAR(500)       '$.content.attachment.title',
