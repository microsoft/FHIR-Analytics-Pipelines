CREATE EXTERNAL TABLE [fhir].[CapabilityStatement] (
    ...
    [software.releaseDate] VARCHAR(30),
    ...
    [implementation.custodian.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[rest.JSON]) with (
        ...
        [rest.security.id]             NVARCHAR(4000)      '$.security.id',
