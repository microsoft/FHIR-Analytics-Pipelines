CREATE EXTERNAL TABLE [fhir].[DetectedIssue] (
    ...
    [identified.dateTime] VARCHAR(30),
    [identified.period.id] NVARCHAR(4000),
    [identified.period.extension] NVARCHAR(MAX),
    [identified.period.start] VARCHAR(30),
    [identified.period.end] VARCHAR(30),
) WITH (
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[mitigation.JSON]) with (
        ...
        [mitigation.date]              VARCHAR(30)         '$.date',
