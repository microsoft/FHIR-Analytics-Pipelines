CREATE EXTERNAL TABLE [fhir].[Consent] (
    ...
    [provision.dataPeriod.id] NVARCHAR(4000),
    [provision.dataPeriod.extension] NVARCHAR(MAX),
    [provision.dataPeriod.start] VARCHAR(30),
    [provision.dataPeriod.end] VARCHAR(30),
    [provision.data] VARCHAR(MAX),
    [provision.provision] VARCHAR(MAX),
    [source.attachment.id] NVARCHAR(4000),
    [source.attachment.extension] NVARCHAR(MAX),
    [source.attachment.contentType] NVARCHAR(4000),
    [source.attachment.language] NVARCHAR(4000),
    ...
    [source.attachment.creation] VARCHAR(30),
    ...
    [source.reference.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[organization.JSON]) with (
        [organization.id]              NVARCHAR(4000)      '$.id',
        ...
        [organization.identifier.id]   NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[verification.JSON]) with (
        [verification.id]              NVARCHAR(4000)      '$.id',
        ...
        [verification.verifiedWith.id] NVARCHAR(4000)      '$.verifiedWith.id',
        ...
        [verification.verificationDate] VARCHAR(30)         '$.verificationDate'
    ) j
