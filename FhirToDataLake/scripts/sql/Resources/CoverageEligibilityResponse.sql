CREATE EXTERNAL TABLE [fhir].[CoverageEligibilityResponse] (
    ...
    [error] VARCHAR(MAX),
    [serviced.date] VARCHAR(10),
    [serviced.Period.id] NVARCHAR(4000),
    [serviced.Period.extension] NVARCHAR(MAX),
    [serviced.Period.start] VARCHAR(30),
    [serviced.Period.end] VARCHAR(30),
) WITH (
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[insurance.JSON]) with (
        ...
        [insurance.benefitPeriod.id]   NVARCHAR(4000)      '$.benefitPeriod.id',
        [insurance.benefitPeriod.extension] NVARCHAR(MAX)       '$.benefitPeriod.extension',
        [insurance.benefitPeriod.start] VARCHAR(30)         '$.benefitPeriod.start',
        [insurance.benefitPeriod.end]  VARCHAR(30)         '$.benefitPeriod.end',
