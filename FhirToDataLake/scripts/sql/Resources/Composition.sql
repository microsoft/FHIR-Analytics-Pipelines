...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[relatesTo.JSON]) with (
        ...
        [relatesTo.target.Identifier.id] NVARCHAR(4000)      '$.target.Identifier.id',
        ...
        [relatesTo.target.Reference.id] NVARCHAR(4000)      '$.target.Reference.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[event.JSON]) with (
        ...
        [event.period.id]              NVARCHAR(4000)      '$.period.id',
        [event.period.extension]       NVARCHAR(MAX)       '$.period.extension',
        [event.period.start]           VARCHAR(30)         '$.period.start',
        [event.period.end]             VARCHAR(30)         '$.period.end',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[section.JSON]) with (
        ...
        [section.code.id]              NVARCHAR(4000)      '$.code.id',
        ...
        [section.focus.id]             NVARCHAR(4000)      '$.focus.id',
        ...
        [section.text.id]              NVARCHAR(4000)      '$.text.id',
        ...
        [section.mode]                 NVARCHAR(4000)      '$.mode',
        [section.orderedBy.id]         NVARCHAR(4000)      '$.orderedBy.id',
        ...
        [section.emptyReason.id]       NVARCHAR(4000)      '$.emptyReason.id',
