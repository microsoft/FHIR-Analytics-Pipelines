CREATE EXTERNAL TABLE [fhir].[Location] (
    ...
    [address.city] NVARCHAR(4000),
    [address.district] NVARCHAR(4000),
    [address.state] NVARCHAR(4000),
    [address.postalCode] NVARCHAR(4000),
    [address.country] NVARCHAR(4000),
    [address.period.id] NVARCHAR(4000),
    [address.period.extension] NVARCHAR(MAX),
    [address.period.start] VARCHAR(30),
    [address.period.end] VARCHAR(30),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[hoursOfOperation.JSON]) with (
        [hoursOfOperation.id]          NVARCHAR(4000)      '$.id',
