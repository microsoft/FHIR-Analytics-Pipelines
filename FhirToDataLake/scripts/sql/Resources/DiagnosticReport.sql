...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[resultsInterpreter.JSON]) with (
        [resultsInterpreter.id]        NVARCHAR(4000)      '$.id',
        ...
        [resultsInterpreter.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[imagingStudy.JSON]) with (
        [imagingStudy.id]              NVARCHAR(4000)      '$.id',
        ...
        [imagingStudy.identifier.id]   NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[media.JSON]) with (
        ...
        [media.link.id]                NVARCHAR(4000)      '$.link.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[conclusionCode.JSON]) with (
        [conclusionCode.id]            NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[presentedForm.JSON]) with (
        [presentedForm.id]             NVARCHAR(4000)      '$.id',
        [presentedForm.extension]      NVARCHAR(MAX)       '$.extension',
        [presentedForm.contentType]    NVARCHAR(4000)      '$.contentType',
        [presentedForm.language]       NVARCHAR(4000)      '$.language',
        ...
        [presentedForm.creation]       VARCHAR(30)         '$.creation'
    ) j
