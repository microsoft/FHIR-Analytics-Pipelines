...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[subunit.JSON]) with (
        ...
        [subunit.sequenceAttachment.contentType] NVARCHAR(64)        '$.sequenceAttachment.contentType',
        [subunit.sequenceAttachment.language] NVARCHAR(12)        '$.sequenceAttachment.language',
        ...
        [subunit.sequenceAttachment.title] NVARCHAR(500)       '$.sequenceAttachment.title',
