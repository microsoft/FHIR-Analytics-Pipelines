...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[subunit.JSON]) with (
        ...
        [subunit.sequenceAttachment.id] NVARCHAR(4000)      '$.sequenceAttachment.id',
        [subunit.sequenceAttachment.extension] NVARCHAR(MAX)       '$.sequenceAttachment.extension',
        [subunit.sequenceAttachment.contentType] NVARCHAR(4000)      '$.sequenceAttachment.contentType',
        [subunit.sequenceAttachment.language] NVARCHAR(4000)      '$.sequenceAttachment.language',
        ...
        [subunit.sequenceAttachment.creation] VARCHAR(30)         '$.sequenceAttachment.creation',
        ...
        [subunit.nTerminalModification] NVARCHAR(4000)      '$.nTerminalModification',
        [subunit.cTerminalModificationId.id] NVARCHAR(4000)      '$.cTerminalModificationId.id',
        ...
        [subunit.cTerminalModification] NVARCHAR(4000)      '$.cTerminalModification'
    ) j
