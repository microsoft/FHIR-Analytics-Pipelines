CREATE EXTERNAL TABLE [fhir].[AuditEvent] (
    ...
    [source.site] NVARCHAR(4000),
    [source.observer.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[subtype.JSON]) with (
        ...
        [subtype.version]              NVARCHAR(4000)      '$.version',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[purposeOfEvent.JSON]) with (
        [purposeOfEvent.id]            NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[agent.JSON]) with (
        ...
        [agent.who.id]                 NVARCHAR(4000)      '$.who.id',
        ...
        [agent.altId]                  NVARCHAR(4000)      '$.altId',
        [agent.name]                   NVARCHAR(4000)      '$.name',
        [agent.requestor]              bit                 '$.requestor',
        [agent.location.id]            NVARCHAR(4000)      '$.location.id',
        ...
        [agent.network.id]             NVARCHAR(4000)      '$.network.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[entity.JSON]) with (
        ...
        [entity.name]                  NVARCHAR(4000)      '$.name',
