CREATE EXTERNAL TABLE [fhir].[AppointmentResponse] (
    ...
    [participantStatus] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[participantType.JSON]) with (
        [participantType.id]           NVARCHAR(4000)      '$.id',
