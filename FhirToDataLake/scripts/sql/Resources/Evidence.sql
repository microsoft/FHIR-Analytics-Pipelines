...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[exposureVariant.JSON]) with (
        [exposureVariant.id]           NVARCHAR(4000)      '$.id',
        ...
        [exposureVariant.identifier.id] NVARCHAR(4000)      '$.identifier.id',
