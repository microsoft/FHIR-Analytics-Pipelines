CREATE EXTERNAL TABLE [fhir].[Evidence] (
    ...
    [exposureBackground.id] NVARCHAR(100),
    [exposureBackground.extension] NVARCHAR(MAX),
    [exposureBackground.reference] NVARCHAR(4000),
    [exposureBackground.type] VARCHAR(256),
    [exposureBackground.identifier.id] NVARCHAR(100),
    [exposureBackground.identifier.extension] NVARCHAR(MAX),
    [exposureBackground.identifier.use] NVARCHAR(64),
    [exposureBackground.identifier.type] NVARCHAR(MAX),
    [exposureBackground.identifier.system] VARCHAR(256),
    [exposureBackground.identifier.value] NVARCHAR(4000),
    [exposureBackground.identifier.period] NVARCHAR(MAX),
    [exposureBackground.identifier.assigner] NVARCHAR(MAX),
    [exposureBackground.display] NVARCHAR(4000),
    [exposureVariant] VARCHAR(MAX),
    [outcome] VARCHAR(MAX),
) WITH (
    LOCATION='/Evidence/**',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[relatedArtifact.JSON]) with (
        ...
        [relatedArtifact.document.contentType] NVARCHAR(64)        '$.document.contentType',
        [relatedArtifact.document.language] NVARCHAR(12)        '$.document.language',
        ...
        [relatedArtifact.document.title] NVARCHAR(500)       '$.document.title',
...
CREATE VIEW fhir.EvidenceExposureVariant AS
SELECT
    [id],
    [exposureVariant.JSON],
    [exposureVariant.id],
    [exposureVariant.extension],
    [exposureVariant.reference],
    [exposureVariant.type],
    [exposureVariant.identifier.id],
    [exposureVariant.identifier.extension],
    [exposureVariant.identifier.use],
    [exposureVariant.identifier.type],
    [exposureVariant.identifier.system],
    [exposureVariant.identifier.value],
    [exposureVariant.identifier.period],
    [exposureVariant.identifier.assigner],
    [exposureVariant.display]
FROM openrowset (
        BULK 'Evidence/**',
        DATA_SOURCE = 'ParquetSource',
        FORMAT = 'PARQUET'
        ...
        [id]   VARCHAR(64),
       [exposureVariant.JSON]  VARCHAR(MAX) '$.exposureVariant'
    ) AS rowset
    CROSS APPLY openjson (rowset.[exposureVariant.JSON]) with (
        [exposureVariant.id]           NVARCHAR(100)       '$.id',
        [exposureVariant.extension]    NVARCHAR(MAX)       '$.extension',
        [exposureVariant.reference]    NVARCHAR(4000)      '$.reference',
        [exposureVariant.type]         VARCHAR(256)        '$.type',
        [exposureVariant.identifier.id] NVARCHAR(100)       '$.identifier.id',
        [exposureVariant.identifier.extension] NVARCHAR(MAX)       '$.identifier.extension',
        [exposureVariant.identifier.use] NVARCHAR(64)        '$.identifier.use',
        [exposureVariant.identifier.type] NVARCHAR(MAX)       '$.identifier.type',
        [exposureVariant.identifier.system] VARCHAR(256)        '$.identifier.system',
        [exposureVariant.identifier.value] NVARCHAR(4000)      '$.identifier.value',
        [exposureVariant.identifier.period] NVARCHAR(MAX)       '$.identifier.period',
        [exposureVariant.identifier.assigner] NVARCHAR(MAX)       '$.identifier.assigner',
        [exposureVariant.display]      NVARCHAR(4000)      '$.display'
    ) j

GO

CREATE VIEW fhir.EvidenceOutcome AS
SELECT
    [id],
    [outcome.JSON],
    [outcome.id],
    ...
    [outcome.reference],
    [outcome.type],
    [outcome.identifier.id],
    [outcome.identifier.extension],
    [outcome.identifier.use],
    [outcome.identifier.type],
    [outcome.identifier.system],
    [outcome.identifier.value],
    [outcome.identifier.period],
    [outcome.identifier.assigner],
    [outcome.display]
FROM openrowset (
        BULK 'Evidence/**',
        DATA_SOURCE = 'ParquetSource',
    ...
    CROSS APPLY openjson (rowset.[outcome.JSON]) with (
        ...
        [outcome.reference]            NVARCHAR(4000)      '$.reference',
        [outcome.type]                 VARCHAR(256)        '$.type',
        [outcome.identifier.id]        NVARCHAR(100)       '$.identifier.id',
        [outcome.identifier.extension] NVARCHAR(MAX)       '$.identifier.extension',
        [outcome.identifier.use]       NVARCHAR(64)        '$.identifier.use',
        [outcome.identifier.type]      NVARCHAR(MAX)       '$.identifier.type',
        [outcome.identifier.system]    VARCHAR(256)        '$.identifier.system',
        [outcome.identifier.value]     NVARCHAR(4000)      '$.identifier.value',
        [outcome.identifier.period]    NVARCHAR(MAX)       '$.identifier.period',
        [outcome.identifier.assigner]  NVARCHAR(MAX)       '$.identifier.assigner',
        [outcome.display]              NVARCHAR(4000)      '$.display'
    ) j
