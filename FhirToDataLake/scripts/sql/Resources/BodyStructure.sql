...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[locationQualifier.JSON]) with (
        [locationQualifier.id]         NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[image.JSON]) with (
        [image.id]                     NVARCHAR(4000)      '$.id',
        [image.extension]              NVARCHAR(MAX)       '$.extension',
        [image.contentType]            NVARCHAR(4000)      '$.contentType',
        [image.language]               NVARCHAR(4000)      '$.language',
        ...
        [image.creation]               VARCHAR(30)         '$.creation'
    ) j
