CREATE EXTERNAL TABLE [fhir].[DeviceRequest] (
    ...
    [code.codeableConcept.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[priorRequest.JSON]) with (
        [priorRequest.id]              NVARCHAR(4000)      '$.id',
        ...
        [priorRequest.identifier.id]   NVARCHAR(4000)      '$.identifier.id',
