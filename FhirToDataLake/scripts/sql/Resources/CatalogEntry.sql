...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[additionalIdentifier.JSON]) with (
        ...
        [additionalIdentifier.period.id] NVARCHAR(4000)      '$.period.id',
        [additionalIdentifier.period.extension] NVARCHAR(MAX)       '$.period.extension',
        [additionalIdentifier.period.start] VARCHAR(30)         '$.period.start',
        [additionalIdentifier.period.end] VARCHAR(30)         '$.period.end',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[additionalCharacteristic.JSON]) with (
        [additionalCharacteristic.id]  NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[additionalClassification.JSON]) with (
        [additionalClassification.id]  NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[relatedEntry.JSON]) with (
        [relatedEntry.id]              NVARCHAR(4000)      '$.id',
        ...
        [relatedEntry.item.id]         NVARCHAR(4000)      '$.item.id',
