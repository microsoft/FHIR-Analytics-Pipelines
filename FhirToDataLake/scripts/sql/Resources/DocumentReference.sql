...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[content.JSON]) with (
        ...
        [content.attachment.contentType] NVARCHAR(64)        '$.attachment.contentType',
        [content.attachment.language]  NVARCHAR(12)        '$.attachment.language',
        ...
        [content.attachment.title]     NVARCHAR(500)       '$.attachment.title',
