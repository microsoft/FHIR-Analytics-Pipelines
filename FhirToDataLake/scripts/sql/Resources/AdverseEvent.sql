...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[resultingCondition.JSON]) with (
        [resultingCondition.id]        NVARCHAR(4000)      '$.id',
        ...
        [resultingCondition.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[subjectMedicalHistory.JSON]) with (
        [subjectMedicalHistory.id]     NVARCHAR(4000)      '$.id',
        ...
        [subjectMedicalHistory.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[referenceDocument.JSON]) with (
        [referenceDocument.id]         NVARCHAR(4000)      '$.id',
        ...
        [referenceDocument.identifier.id] NVARCHAR(4000)      '$.identifier.id',
