...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[input.JSON]) with (
        ...
        [input.value.attachment.contentType] NVARCHAR(64)        '$.value.attachment.contentType',
        [input.value.attachment.language] NVARCHAR(12)        '$.value.attachment.language',
        ...
        [input.value.attachment.title] NVARCHAR(500)       '$.value.attachment.title',
        ...
        [input.value.money.currency]   NVARCHAR(8)         '$.value.money.currency',
        ...
        [input.value.sampledData.data] NVARCHAR(100)       '$.value.sampledData.data',
        ...
        [input.value.signature.targetFormat] NVARCHAR(500)       '$.value.signature.targetFormat',
        [input.value.signature.sigFormat] NVARCHAR(500)       '$.value.signature.sigFormat',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[output.JSON]) with (
        ...
        [output.value.attachment.contentType] NVARCHAR(64)        '$.value.attachment.contentType',
        [output.value.attachment.language] NVARCHAR(12)        '$.value.attachment.language',
        ...
        [output.value.attachment.title] NVARCHAR(500)       '$.value.attachment.title',
        ...
        [output.value.money.currency]  NVARCHAR(8)         '$.value.money.currency',
        ...
        [output.value.sampledData.data] NVARCHAR(100)       '$.value.sampledData.data',
        ...
        [output.value.signature.targetFormat] NVARCHAR(500)       '$.value.signature.targetFormat',
        [output.value.signature.sigFormat] NVARCHAR(500)       '$.value.signature.sigFormat',
