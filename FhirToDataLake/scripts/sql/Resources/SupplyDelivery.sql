CREATE EXTERNAL TABLE [fhir].[SupplyDelivery] (
    ...
    [suppliedItem.quantity.unit] NVARCHAR(4000),
    [suppliedItem.quantity.system] VARCHAR(256),
    [suppliedItem.quantity.code] NVARCHAR(4000),
    [suppliedItem.item.CodeableConcept.id] NVARCHAR(4000),
    ...
    [suppliedItem.item.Reference.id] NVARCHAR(4000),
