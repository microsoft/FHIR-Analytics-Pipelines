...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[doseStatusReason.JSON]) with (
        [doseStatusReason.id]          NVARCHAR(4000)      '$.id',
