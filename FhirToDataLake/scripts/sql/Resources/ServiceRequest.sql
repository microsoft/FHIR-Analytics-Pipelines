CREATE EXTERNAL TABLE [fhir].[ServiceRequest] (
    ...
    [requisition.id] NVARCHAR(4000),
    [requisition.extension] NVARCHAR(MAX),
    [requisition.use] NVARCHAR(64),
    [requisition.type.id] NVARCHAR(4000),
    ...
    [requisition.period.id] NVARCHAR(4000),
    [requisition.period.extension] NVARCHAR(MAX),
    [requisition.period.start] VARCHAR(30),
    [requisition.period.end] VARCHAR(30),
    ...
    [quantity.ratio.numerator.unit] NVARCHAR(4000),
    [quantity.ratio.numerator.system] VARCHAR(256),
    [quantity.ratio.numerator.code] NVARCHAR(4000),
    [quantity.ratio.denominator.id] NVARCHAR(4000),
    ...
    [asNeeded.codeableConcept.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[orderDetail.JSON]) with (
        [orderDetail.id]               NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[locationCode.JSON]) with (
        [locationCode.id]              NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[locationReference.JSON]) with (
        [locationReference.id]         NVARCHAR(4000)      '$.id',
        ...
        [locationReference.identifier.id] NVARCHAR(4000)      '$.identifier.id',
