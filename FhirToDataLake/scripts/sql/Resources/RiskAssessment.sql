...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[prediction.JSON]) with (
        ...
        [prediction.qualitativeRisk.id] NVARCHAR(4000)      '$.qualitativeRisk.id',
        ...
        [prediction.probability.range.id] NVARCHAR(4000)      '$.probability.range.id',
        ...
        [prediction.when.period.id]    NVARCHAR(4000)      '$.when.period.id',
        [prediction.when.period.extension] NVARCHAR(MAX)       '$.when.period.extension',
        [prediction.when.period.start] VARCHAR(30)         '$.when.period.start',
        [prediction.when.period.end]   VARCHAR(30)         '$.when.period.end',
