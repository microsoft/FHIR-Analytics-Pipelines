CREATE EXTERNAL TABLE [fhir].[MeasureReport] (
    ...
    [reporter.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[group.JSON]) with (
        ...
        [group.measureScore.id]        NVARCHAR(4000)      '$.measureScore.id',
        ...
        [group.measureScore.unit]      NVARCHAR(4000)      '$.measureScore.unit',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[evaluatedResource.JSON]) with (
        [evaluatedResource.id]         NVARCHAR(4000)      '$.id',
        ...
        [evaluatedResource.identifier.id] NVARCHAR(4000)      '$.identifier.id',
