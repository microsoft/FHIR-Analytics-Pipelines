...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[goal.JSON]) with (
        ...
        [goal.category.id]             NVARCHAR(4000)      '$.category.id',
        ...
        [goal.description.id]          NVARCHAR(4000)      '$.description.id',
        ...
        [goal.priority.id]             NVARCHAR(4000)      '$.priority.id',
        ...
        [goal.start.id]                NVARCHAR(4000)      '$.start.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[action.JSON]) with (
        ...
        [action.subject.codeableConcept.id] NVARCHAR(4000)      '$.subject.codeableConcept.id',
        ...
        [action.subject.reference.id]  NVARCHAR(4000)      '$.subject.reference.id',
