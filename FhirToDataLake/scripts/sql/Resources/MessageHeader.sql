CREATE EXTERNAL TABLE [fhir].[MessageHeader] (
    ...
    [source.name] NVARCHAR(4000),
    [source.software] NVARCHAR(4000),
    [source.version] NVARCHAR(4000),
    [source.contact.id] NVARCHAR(4000),
    ...
    [response.details.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[destination.JSON]) with (
        ...
        [destination.name]             NVARCHAR(4000)      '$.name',
        [destination.target.id]        NVARCHAR(4000)      '$.target.id',
        ...
        [destination.receiver.id]      NVARCHAR(4000)      '$.receiver.id',
