CREATE EXTERNAL TABLE [fhir].[ObservationDefinition] (
    ...
    [preferredReportName] NVARCHAR(4000),
    [quantitativeDetails.id] NVARCHAR(4000),
    [quantitativeDetails.extension] NVARCHAR(MAX),
    [quantitativeDetails.modifierExtension] NVARCHAR(MAX),
    [quantitativeDetails.customaryUnit.id] NVARCHAR(4000),
    ...
    [quantitativeDetails.unit.id] NVARCHAR(4000),
    ...
    [normalCodedValueSet.id] NVARCHAR(4000),
    ...
    [normalCodedValueSet.identifier.id] NVARCHAR(4000),
    ...
    [abnormalCodedValueSet.id] NVARCHAR(4000),
    ...
    [abnormalCodedValueSet.identifier.id] NVARCHAR(4000),
    ...
    [criticalCodedValueSet.id] NVARCHAR(4000),
    ...
    [criticalCodedValueSet.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[qualifiedInterval.JSON]) with (
        [qualifiedInterval.id]         NVARCHAR(4000)      '$.id',
        ...
        [qualifiedInterval.range.id]   NVARCHAR(4000)      '$.range.id',
        ...
        [qualifiedInterval.context.id] NVARCHAR(4000)      '$.context.id',
        ...
        [qualifiedInterval.age.id]     NVARCHAR(4000)      '$.age.id',
        ...
        [qualifiedInterval.gestationalAge.id] NVARCHAR(4000)      '$.gestationalAge.id',
        ...
        [qualifiedInterval.condition]  NVARCHAR(4000)      '$.condition'
    ) j
