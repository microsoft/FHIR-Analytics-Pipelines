CREATE EXTERNAL TABLE [fhir].[NutritionOrder] (
    ...
    [orderer.identifier.id] NVARCHAR(4000),
    ...
    [enteralFormula.baseFormulaProductName] NVARCHAR(4000),
    [enteralFormula.additiveType.id] NVARCHAR(4000),
    ...
    [enteralFormula.additiveProductName] NVARCHAR(4000),
    [enteralFormula.caloricDensity.id] NVARCHAR(4000),
    ...
    [enteralFormula.caloricDensity.unit] NVARCHAR(4000),
    [enteralFormula.caloricDensity.system] VARCHAR(256),
    [enteralFormula.caloricDensity.code] NVARCHAR(4000),
    [enteralFormula.routeofAdministration.id] NVARCHAR(4000),
    ...
    [enteralFormula.maxVolumeToDeliver.id] NVARCHAR(4000),
    ...
    [enteralFormula.maxVolumeToDeliver.unit] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[allergyIntolerance.JSON]) with (
        [allergyIntolerance.id]        NVARCHAR(4000)      '$.id',
        ...
        [allergyIntolerance.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[foodPreferenceModifier.JSON]) with (
        [foodPreferenceModifier.id]    NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[excludeFoodModifier.JSON]) with (
        [excludeFoodModifier.id]       NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[supplement.JSON]) with (
        ...
        [supplement.productName]       NVARCHAR(4000)      '$.productName',
        [supplement.schedule]          NVARCHAR(MAX)       '$.schedule' AS JSON,
        [supplement.quantity.id]       NVARCHAR(4000)      '$.quantity.id',
        ...
        [supplement.quantity.unit]     NVARCHAR(4000)      '$.quantity.unit',
