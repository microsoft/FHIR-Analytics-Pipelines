CREATE EXTERNAL TABLE [fhir].[MedicinalProductPackaged] (
    ...
    [marketingAuthorization.id] NVARCHAR(4000),
    ...
    [marketingAuthorization.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[manufacturer.JSON]) with (
        [manufacturer.id]              NVARCHAR(4000)      '$.id',
        ...
        [manufacturer.identifier.id]   NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[batchIdentifier.JSON]) with (
        ...
        [batchIdentifier.immediatePackaging.id] NVARCHAR(4000)      '$.immediatePackaging.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[packageItem.JSON]) with (
        [packageItem.id]               NVARCHAR(4000)      '$.id',
        ...
        [packageItem.type.id]          NVARCHAR(4000)      '$.type.id',
        ...
        [packageItem.quantity.id]      NVARCHAR(4000)      '$.quantity.id',
        ...
        [packageItem.quantity.unit]    NVARCHAR(4000)      '$.quantity.unit',
        ...
        [packageItem.physicalCharacteristics.id] NVARCHAR(4000)      '$.physicalCharacteristics.id',
        ...
        [packageItem.physicalCharacteristics.shape] NVARCHAR(4000)      '$.physicalCharacteristics.shape',
