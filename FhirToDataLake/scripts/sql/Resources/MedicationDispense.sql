CREATE EXTERNAL TABLE [fhir].[MedicationDispense] (
    ...
    [destination.identifier.id] NVARCHAR(4000),
    ...
    [substitution.type.id] NVARCHAR(4000),
    ...
    [statusReason.codeableConcept.id] NVARCHAR(4000),
    ...
    [statusReason.reference.id] NVARCHAR(4000),
    ...
    [statusReason.reference.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[performer.JSON]) with (
        ...
        [performer.function.id]        NVARCHAR(4000)      '$.function.id',
        ...
        [performer.actor.id]           NVARCHAR(4000)      '$.actor.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[authorizingPrescription.JSON]) with (
        [authorizingPrescription.id]   NVARCHAR(4000)      '$.id',
        ...
        [authorizingPrescription.identifier.id] NVARCHAR(4000)      '$.identifier.id',
