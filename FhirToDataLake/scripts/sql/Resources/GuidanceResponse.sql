CREATE EXTERNAL TABLE [fhir].[GuidanceResponse] (
    ...
    [requestIdentifier.id] NVARCHAR(4000),
    [requestIdentifier.extension] NVARCHAR(MAX),
    [requestIdentifier.use] NVARCHAR(64),
    [requestIdentifier.type.id] NVARCHAR(4000),
    ...
    [requestIdentifier.period.id] NVARCHAR(4000),
    [requestIdentifier.period.extension] NVARCHAR(MAX),
    [requestIdentifier.period.start] VARCHAR(30),
    [requestIdentifier.period.end] VARCHAR(30),
    ...
    [module.codeableConcept.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[evaluationMessage.JSON]) with (
        [evaluationMessage.id]         NVARCHAR(4000)      '$.id',
        ...
        [evaluationMessage.identifier.id] NVARCHAR(4000)      '$.identifier.id',
