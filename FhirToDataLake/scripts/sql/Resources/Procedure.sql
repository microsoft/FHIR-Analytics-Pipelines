...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[performer.JSON]) with (
        ...
        [performer.onBehalfOf.id]      NVARCHAR(4000)      '$.onBehalfOf.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[complication.JSON]) with (
        [complication.id]              NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[complicationDetail.JSON]) with (
        [complicationDetail.id]        NVARCHAR(4000)      '$.id',
        ...
        [complicationDetail.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[focalDevice.JSON]) with (
        ...
        [focalDevice.manipulated.id]   NVARCHAR(4000)      '$.manipulated.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[usedReference.JSON]) with (
        [usedReference.id]             NVARCHAR(4000)      '$.id',
        ...
        [usedReference.identifier.id]  NVARCHAR(4000)      '$.identifier.id',
