CREATE EXTERNAL TABLE [fhir].[ClaimResponse] (
    ...
    [payment.adjustment.currency] NVARCHAR(8),
    ...
    [payment.amount.currency] NVARCHAR(8),
    ...
    [form.contentType] NVARCHAR(64),
    [form.language] NVARCHAR(12),
    [form.data] NVARCHAR(MAX),
    [form.url] VARCHAR(256),
    [form.size] bigint,
    [form.hash] NVARCHAR(MAX),
    [form.title] NVARCHAR(500),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[addItem.JSON]) with (
        ...
        [addItem.unitPrice.currency]   NVARCHAR(8)         '$.unitPrice.currency',
        ...
        [addItem.net.currency]         NVARCHAR(8)         '$.net.currency',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[adjudication.JSON]) with (
        ...
        [adjudication.amount.currency] NVARCHAR(8)         '$.amount.currency',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[total.JSON]) with (
        ...
        [total.amount.currency]        NVARCHAR(8)         '$.amount.currency'
    ) j
