...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[supportingInfo.JSON]) with (
        ...
        [supportingInfo.value.attachment.contentType] NVARCHAR(64)        '$.value.attachment.contentType',
        [supportingInfo.value.attachment.language] NVARCHAR(12)        '$.value.attachment.language',
        ...
        [supportingInfo.value.attachment.title] NVARCHAR(500)       '$.value.attachment.title',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[item.JSON]) with (
        ...
        [item.net.currency]            NVARCHAR(8)         '$.net.currency',
