CREATE EXTERNAL TABLE [fhir].[ExplanationOfBenefit] (
    ...
    [fundsReserveRequested.id] NVARCHAR(4000),
    ...
    [benefitPeriod.id] NVARCHAR(4000),
    [benefitPeriod.extension] NVARCHAR(MAX),
    [benefitPeriod.start] VARCHAR(30),
    [benefitPeriod.end] VARCHAR(30),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[preAuthRefPeriod.JSON]) with (
        [preAuthRefPeriod.id]          NVARCHAR(4000)      '$.id',
        [preAuthRefPeriod.extension]   NVARCHAR(MAX)       '$.extension',
        [preAuthRefPeriod.start]       VARCHAR(30)         '$.start',
        [preAuthRefPeriod.end]         VARCHAR(30)         '$.end'
    ) j
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[supportingInfo.JSON]) with (
        ...
        [supportingInfo.reason.version] NVARCHAR(4000)      '$.reason.version',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[benefitBalance.JSON]) with (
        ...
        [benefitBalance.name]          NVARCHAR(4000)      '$.name',
        [benefitBalance.description]   NVARCHAR(4000)      '$.description',
        [benefitBalance.network.id]    NVARCHAR(4000)      '$.network.id',
        ...
        [benefitBalance.unit.id]       NVARCHAR(4000)      '$.unit.id',
        ...
        [benefitBalance.term.id]       NVARCHAR(4000)      '$.term.id',
