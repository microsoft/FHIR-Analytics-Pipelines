CREATE EXTERNAL TABLE [fhir].[Encounter] (
    ...
    [account] VARCHAR(MAX),
    [hospitalization.id] NVARCHAR(4000),
    [hospitalization.extension] NVARCHAR(MAX),
    [hospitalization.modifierExtension] NVARCHAR(MAX),
    [hospitalization.preAdmissionIdentifier.id] NVARCHAR(4000),
    ...
    [hospitalization.origin.id] NVARCHAR(4000),
    ...
    [hospitalization.admitSource.id] NVARCHAR(4000),
    ...
    [hospitalization.reAdmission.id] NVARCHAR(4000),
    ...
    [hospitalization.destination.id] NVARCHAR(4000),
    ...
    [hospitalization.dischargeDisposition.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[statusHistory.JSON]) with (
        [statusHistory.id]             NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[episodeOfCare.JSON]) with (
        [episodeOfCare.id]             NVARCHAR(4000)      '$.id',
        ...
        [episodeOfCare.identifier.id]  NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[appointment.JSON]) with (
        [appointment.id]               NVARCHAR(4000)      '$.id',
        ...
        [appointment.identifier.id]    NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[diagnosis.JSON]) with (
        ...
        [diagnosis.condition.id]       NVARCHAR(4000)      '$.condition.id',
        ...
        [diagnosis.use.id]             NVARCHAR(4000)      '$.use.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[location.JSON]) with (
        ...
        [location.physicalType.id]     NVARCHAR(4000)      '$.physicalType.id',
