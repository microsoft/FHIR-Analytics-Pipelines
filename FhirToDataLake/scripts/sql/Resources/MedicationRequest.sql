CREATE EXTERNAL TABLE [fhir].[MedicationRequest] (
    ...
    [performer.identifier.id] NVARCHAR(4000),
    ...
    [performerType.id] NVARCHAR(4000),
    ...
    [courseOfTherapyType.id] NVARCHAR(4000),
    ...
    [dispenseRequest.dispenseInterval.id] NVARCHAR(4000),
    ...
    [dispenseRequest.dispenseInterval.unit] NVARCHAR(4000),
    [dispenseRequest.dispenseInterval.system] VARCHAR(256),
    [dispenseRequest.dispenseInterval.code] NVARCHAR(4000),
    [dispenseRequest.validityPeriod.id] NVARCHAR(4000),
    [dispenseRequest.validityPeriod.extension] NVARCHAR(MAX),
    [dispenseRequest.validityPeriod.start] VARCHAR(30),
    [dispenseRequest.validityPeriod.end] VARCHAR(30),
    [dispenseRequest.numberOfRepeatsAllowed] bigint,
    [dispenseRequest.quantity.id] NVARCHAR(4000),
    ...
    [dispenseRequest.quantity.unit] NVARCHAR(4000),
    [dispenseRequest.quantity.system] VARCHAR(256),
    [dispenseRequest.quantity.code] NVARCHAR(4000),
    [dispenseRequest.expectedSupplyDuration.id] NVARCHAR(4000),
    ...
    [substitution.allowed.codeableConcept.id] NVARCHAR(4000),
    ...
    [medication.codeableConcept.id] NVARCHAR(4000),
    ...
    [medication.reference.id] NVARCHAR(4000),
    ...
    [medication.reference.identifier.id] NVARCHAR(4000),
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[supportingInformation.JSON]) with (
        [supportingInformation.id]     NVARCHAR(4000)      '$.id',
        ...
        [supportingInformation.identifier.id] NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[dosageInstruction.JSON]) with (
        [dosageInstruction.id]         NVARCHAR(4000)      '$.id',
        ...
        [dosageInstruction.timing.id]  NVARCHAR(4000)      '$.timing.id',
        ...
        [dosageInstruction.site.id]    NVARCHAR(4000)      '$.site.id',
        ...
        [dosageInstruction.route.id]   NVARCHAR(4000)      '$.route.id',
        ...
        [dosageInstruction.method.id]  NVARCHAR(4000)      '$.method.id',
        ...
        [dosageInstruction.maxDosePerPeriod.id] NVARCHAR(4000)      '$.maxDosePerPeriod.id',
        ...
        [dosageInstruction.maxDosePerAdministration.id] NVARCHAR(4000)      '$.maxDosePerAdministration.id',
        ...
        [dosageInstruction.maxDosePerAdministration.unit] NVARCHAR(4000)      '$.maxDosePerAdministration.unit',
        ...
        [dosageInstruction.maxDosePerLifetime.id] NVARCHAR(4000)      '$.maxDosePerLifetime.id',
        ...
        [dosageInstruction.maxDosePerLifetime.unit] NVARCHAR(4000)      '$.maxDosePerLifetime.unit',
        ...
        [dosageInstruction.asNeeded.codeableConcept.id] NVARCHAR(4000)      '$.asNeeded.codeableConcept.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[detectedIssue.JSON]) with (
        [detectedIssue.id]             NVARCHAR(4000)      '$.id',
        ...
        [detectedIssue.identifier.id]  NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[eventHistory.JSON]) with (
        [eventHistory.id]              NVARCHAR(4000)      '$.id',
        ...
        [eventHistory.identifier.id]   NVARCHAR(4000)      '$.identifier.id',
