...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[interpreter.JSON]) with (
        [interpreter.id]               NVARCHAR(4000)      '$.id',
        ...
        [interpreter.identifier.id]    NVARCHAR(4000)      '$.identifier.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[procedureCode.JSON]) with (
        [procedureCode.id]             NVARCHAR(4000)      '$.id',
...
FROM openrowset (
    ...
    CROSS APPLY openjson (rowset.[series.JSON]) with (
        ...
        [series.started]               VARCHAR(30)         '$.started',
