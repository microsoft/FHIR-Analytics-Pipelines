...
namespace Microsoft.Health.AnalyticsConnector.DataClient.Extensions
{
    public static class DateTimeOffsetExtensions
    {
        ...
        /// This is different from the standard format string "o"
        ...
        {
            return offset.ToString(InstantFormat);
        }
    }
}
