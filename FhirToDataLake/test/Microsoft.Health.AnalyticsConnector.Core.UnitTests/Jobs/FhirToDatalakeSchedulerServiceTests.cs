...
using Microsoft.Health.AnalyticsConnector.Core.Jobs.Models.AzureStorage;using Microsoft.Health.JobManagement;
using NCrontab;
...
namespace Microsoft.Health.AnalyticsConnector.Core.UnitTests.Jobs
{
    public class FhirToDatalakeSchedulerServiceTests
    {
        ...
        {
            MockMetricsLogger metricsLogger = new MockMetricsLogger(new NullLogger<MockMetricsLogger>());
