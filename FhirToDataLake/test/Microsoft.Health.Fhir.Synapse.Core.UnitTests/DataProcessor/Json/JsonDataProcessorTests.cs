...
namespace Microsoft.Health.Fhir.Synapse.Core.UnitTests.DataProcessor.Json
{
    public class JsonDataProcessorTests
    {
        ...
        private const string _testDataFolder = "./DataProcessor/Json/TestData";
        private const string _expectTestDataFolder = "./DataProcessor/Json/TestData/Expected";
