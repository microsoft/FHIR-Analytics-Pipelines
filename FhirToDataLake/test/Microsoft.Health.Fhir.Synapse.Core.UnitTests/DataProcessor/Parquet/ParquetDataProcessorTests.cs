...
namespace Microsoft.Health.Fhir.Synapse.Core.UnitTests.DataProcessor.Parquet
{
    public class ParquetDataProcessorTests
    {
        ...
        private const string _testDataFolder = "./DataProcessor/Parquet/TestData";
        private const string _expectTestDataFolder = "./DataProcessor/Parquet/TestData/Expected";
