...
Use the button below to deploy the pipeline with [ARM template](https://github.com/microsoft/FHIR-Analytics-Pipelines/blob/main/FhirToDataLake/deploy/templates/ContainerApp/DeployFhirPipelineToContainerApp.json) through the Azure Portal.
...
### 4.	Provide access of the Container Registry to the Azure Container App
