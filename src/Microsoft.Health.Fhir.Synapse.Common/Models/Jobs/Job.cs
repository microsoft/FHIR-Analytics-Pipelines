...
namespace Microsoft.Health.Fhir.Synapse.Common.Models.Jobs
{
    public class Job
    {
        ...
        /// <summary>
        /// Gets or sets offset map of job.
        /// </summary>
        [JsonProperty("resourceProgresses")]
        public Dictionary<string, string> ResourceProgresses { get; } = new Dictionary<string, string>();

        /// <summary>
        /// Total resource count (from data source) for each resource types.
        /// </summary>
        [JsonProperty("totalResourceCounts")]
        public Dictionary<string, int> TotalResourceCounts { get; } = new Dictionary<string, int>();

        /// <summary>
        /// Processed resource count for each resource type.
        /// </summary>
        [JsonProperty("processedResourceCounts")]
        public Dictionary<string, int> ProcessedResourceCounts { get; } = new Dictionary<string, int>();

        /// <summary>
        /// Skipped resource count for each resource type.
        /// </summary>
        [JsonProperty("skippedResourceCounts")]
        public Dictionary<string, int> SkippedResourceCounts { get; } = new Dictionary<string, int>();

        /// <summary>
        /// Part id for each resource type.
        /// </summary>
        [JsonProperty("partIds")]
        public Dictionary<string, int> PartIds { get; } = new Dictionary<string, int>();
